...
export function ChatDialogs() {
	...
	const onSubmit = (event: FormEvent) => { event.preventDefault(); if (dialog === "create-server") void createServer(value); if (dialog === "create-channel") void createChannel(value); if (dialog === "join-server") void joinServer(value); };
